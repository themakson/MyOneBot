...
public interface Handler<T> {
    ...
    @Component
    class TextHandler implements Handler<Message> {
        ...
        private final ThisIsMyBot.MyOneBot.cahce.Cache<User> userCache;

        @Autowired
        public TextHandler(@Lazy MessageSender messageSender, BuildSendMessageService buildSendMessageService, BuildInlineButtonsService buildInlineButtonsService, @Lazy BuildButtonsService buildButtonsService, ThisIsMyBot.MyOneBot.cahce.UserCache userCache) {
